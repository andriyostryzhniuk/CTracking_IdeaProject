...
public class DatePicker extends HBox {
     ...
     */
    public void tryParse(boolean setDateToNullOnException) {
        if (timer != null) {
            timer.cancel();
        }
        try {
    ...
    private void updateTextField() {
        ...
        if (selectedDateProperty().get() != null) {
            DateFormat dateFormat = new SimpleDateFormat(", yyyy", new Locale("uk"));
            String date = dateFormat.format(selectedDateProperty().get());
